...
def compute_muscle_intensity(cfg: Dict[str, Any], strength01: float) -> int:
    """Shape a 0..1 zone strength into a 0-100 OWO muscle intensity using the
    muscle's threshold / gain / max_intensity. Pure + testable."""
...
class OwoRouter(PollingRouter):
    ...
    def compute_targets(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for name, cfg in cfgs.items():
            ...
            intensity = compute_muscle_intensity(cfg, strength01)
            if intensity > 0:
