...
```
tools\testbench\run_testbench.bat      # or, from tools\:  python -m testbench
```

Build a standalone exe (`OGP_TestBench.exe` in `tools\testbench\dist\`):

```
tools\testbench\build_testbench.bat
```
