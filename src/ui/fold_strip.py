...
those design decisions so any per-item view can render its cards in the same
...
class FoldCard(QFrame):
    ...
    def __init__(self, fold_id: str, title: str,
        ...
        # display (e.g. a live meter grid) — no editor, no
    ...
    def add_header_widget(self, widget: QWidget) -> None:
        ...
        stretch) — for small controls that belong to the fold's title."""
