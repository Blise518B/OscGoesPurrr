...
class SpsSourcesMixin:
    ...
    def _build_sps_source_card(self, idx: int, src: Dict[str, Any]) -> QFrame:
        ...
        self._explain(
            enable_cb, "On / off",
            "Off stops this source contributing anywhere, without losing "
        ...
        self._explain(
            ...
            "touch the contacts in VRChat and watch it move.")
        self._explain(
            del_btn, "Delete source",
            "Removes this source for good. Toys that listened to it stop "
            "reacting to it.")
    ...
    def _sps_contact_row(self, parent_lay, label, value, placeholder, idx,
        ...
        if help_text is not None:
            self._explain((lbl, edit), *help_text)
        pick = QPushButton("+")
