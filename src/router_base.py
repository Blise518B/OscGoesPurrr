...
#
# Every simple polling router does the
...
#
# A router with a bespoke tick (anti-stuck ramp + raw/override
...
# analogue of motor_router's anti-stuck fuse.
#
...
class StaleSignalMonitor:
    ...
    PollingRouter and any discrete-event router (whose sustain
